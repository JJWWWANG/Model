...
def parse_opt():
    ...
    parser.add_argument('--exp_dir', '-ed', type=str, default='experiments/super/msFormer-1f')#hrFormerS1-noconv2_lr1e-3
    parser.add_argument('--cache_dir', '-cd', type=str, default='')
    parser.add_argument('--lmdb_label_dir', '-lld', type=str, default='')
    ...
    model.add_argument('--model_name', '-mn', type=str, default='msformer')
    ...
    training.add_argument('-b', '--batch_size', type=int, default=256, help='minibatch size')#原256
    ...
    training.add_argument('--start_epoch', type=int, default=50)
